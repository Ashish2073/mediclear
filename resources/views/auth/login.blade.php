...
<style>
    body {
        background-image: url("public/assests/img/mediclearbg.jpg");
            ...
            <div class="col-sm-5 mx-auto divup pt-5">
                <div class="divdown mt-5">
                    ...
                    <div class="h5 text-center">
                        <input type="email" class="form-control border rounded btn-lg bg-light shadow-lg text" placeholder="Email" name="email" />
                        {{-- <x-input-error :messages="$errors->get('email')" class="mt-2" /> --}}
                        <br>

                        <input type="password" class="form-control border rounded btn-lg bg-light shadow-lg text" placeholder="Password" name="password" />
                        {{-- <x-input-error :messages="$errors->get('password')" class="mt-2" /> --}}
 <br>
                        ...
                        <div class="d-flex  justify-content-end">
                            <span><a href="{{ route('password.request') }}" class="text-decoration-none text-white">forget Password?</a></span>
                        </div>
                        <br>


                        <button class="btn btn-light text-dark btn-lg forbutton"
                        type="submit"   class="login"> Login</a>
                        </button>
