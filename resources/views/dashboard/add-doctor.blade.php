                              ...
                              <span class="input-group-append">
                                ...
                                <div class="col-sm-3 end-date">
                                    ...
                                    <div class="input-group date d-flex" id="datepicker1">
                                        <input type="date" class="form-control" name="start" id="date" value="{{ $start ?? ''}}" placeholder="dd-mm-yyyy" />
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3 end-date">
                                    ...
                                    <div class="input-group date d-flex" id="datepicker2">
                                        <input type="date" name="end" class="form-control" id="date" value="{{ $end ?? ''}}" placeholder="dd-mm-yyyy" />
                                                                            </div>
                                </div>
                           ...
                           <div class="input-group date d-flex" id="datepicker1">
                              ...
                              <span class="input-group-append">
                                ...
                                <div class="col-sm-2" style="position: relative; top: 47px;">
                                    <div class="Click-here"> <button class="btn   bg-gradient-success text-white shadow-lg" type="button" style="padding: 4px 8px; font-size:17px;" data-target=" #mymodel" data-toggle="modal">+ Add Doctor</button>
                                        <!-- poppux box start -->
                                        <div class="modal mt-4" id="mymodel">
                                            <div class="modal-dialog m-auto">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <form action="{{url('adddocter')}}" enctype="multipart/form-data" method="POST" class="text-center">
                                                            @csrf
                            ...
                            <table id="example" class="display nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <img src="{{url('/images/'.$doctor->sign)}}"  width="100px" alt=""> </td>
                                        <td> <img src="{{url('/images/'.$doctor->seal_of_doctor)}}"  width="100px" alt=""> </td>
                                        {{-- <td>MED001</td> --}}
                                        {{-- <td>*********23</td> --}}
                                        ...
                                        <td> <i class="fa-solid fa-pen-to-square text-success"   style="cursor: pointer"
                                            ...
                                            style="font-size:1rem;"
                                            onclick="{document.getElementById('id1').value={{ $doctor->id }}}"></i></td>
                                    </tr>
