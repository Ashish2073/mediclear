...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h3 class="h3 mb-2 text-gray-800">Corporate ID</h3>
                              ...
                              <span class="input-group-append">
                                ...
                                <div class="col-sm-3 end-date">
                                    ...
                                    <div class="input-group date d-flex">
                                        <input type="date" name="start" class="form-control" id="date"
                                ...
                                <div class="col-sm-3 end-date">
                                    ...
                                    <div class="input-group date d-flex">
                                        <input type="date" class="form-control" name="end" id="date"
                                ...
                                <div class="col-sm-2" style="position: relative; top: 47px;">
                                    <div class="Click-here"> <button
                                            class="btn  bg-gradient-success   text-white shadow-lg" type="button"
                                            style="padding: 4px 4px; font-size:17px; width:180px;"
                                            data-target=" #mymodel" data-toggle="modal">+ Add Corporate ID</button>
                                        <!-- poppux box start -->
                                        <div class="modal mt-4" id="mymodel">
                                            <div class="modal-dialog m-auto">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <form action="{{ url('/addCorporateID') }}" method="post"
                                                            class="text-center">
                                                            @csrf
                                                            ...
                                                            <input type="text" name="name"
                                                                style="margin-left:50px; margin-bottom:10px;"> <br>
                                                            <label for="">Phone No. &nbsp;&nbsp;&nbsp;&nbsp;
                                                                &nbsp;</label>
                                                            ...
                                                            <input type="text" name="user_id"
                                                                style="margin-left:30px; margin-bottom:10px;"> <br>
                                                            <label for="">Password&nbsp;&nbsp;&nbsp;&nbsp;
                                                                &nbsp;&nbsp;&nbsp;&nbsp;</label>
                                                            <input type="password" name="password"
                                                                style="margin-bottom:10px;"> <br>
                                                            <button type="submit"
                                                                class="btn bg-gradient-success text-white shadow-lg"
                                    ...
                                    @foreach ($corporate as $corporate)
                                        <tr>
                                            ...
                                            <td> <i class="fa-solid fa-pen-to-square text-success"
                                                ...
                                                onclick="{document.getElementById('id').value={{ $corporate->id }}; document.getElementById('name').value='{{ $corporate->name }}'; document.getElementById('email').value='{{ $corporate->email }}'; document.getElementById('mobile_no').value={{ $corporate->mobile_no }};}"></i> &nbsp; <i
