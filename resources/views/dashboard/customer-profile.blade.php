                          ...
                          <span class="input-group-append">
                            ...
                            <div class="col-sm-3 end-date">
                                ...
                                <div class="input-group date d-flex" id="datepicker1">
                                    <input type="date" name="start" value="{{ $start ?? ''}}" class="form-control" id="date" placeholder="dd-mm-yyyy" />
                            ...
                            <div class="col-sm-3 end-date">
                                ...
                                <div class="input-group date d-flex" id="datepicker2">
                                    <input type="date" name="end" class="form-control" value="{{ $end ?? ''}}" id="date" placeholder="dd-mm-yyyy" />
                            ...
                            <div class="col-md-1 " style="margin-left: -12px;  margin-top:47px;">
                                <a href="{{url('/customer-profile')}}" class="btn bg-gradient-success text-white shadow-lg " >Reset</a>
                            </div>
...
@endphp
                                    ...
                                    <tr>
                                        ...
                                        <td> <img src="{{asset('public/customer/'.$customer->customer_profile_image_name)}}" width="70px" alt=""> </td>
                                        ...
                                        <td>  &nbsp; <i class="fa-solid fa-trash text-danger"  onclick="{document.getElementById('id1').value={{ $customer->id }}}" data-toggle="modal" data-target="#exampleModal" style="font-size:1rem;"></i></td>
                                    </tr>
                                    @php
                                        $i++;
                                    @endphp
